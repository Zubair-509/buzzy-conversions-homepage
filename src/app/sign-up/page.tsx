...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert("Account created successfully! (This is a demo - authentication not implemented yet)");
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <main className="flex items-center justify-center min-h-screen pt-16 pb-12 px-4">
        <div className="w-full max-w-md">
          <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-6">
              <CardTitle className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                Join Buzzy Conversions
              </CardTitle>
              <CardDescription className="text-base text-muted-foreground">
                Create your account and start converting files today
              </CardDescription>
            </CardHeader>
