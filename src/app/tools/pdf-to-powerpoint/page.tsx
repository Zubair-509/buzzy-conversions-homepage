...
import { Presentation, Upload, Settings, Download, Shield, Zap, Clock, CheckCircle } from 'lucide-react';
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Transform PDFs into editable PowerPoint presentations. Perfect for creating slides from reports and documents.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border-2 border-primary/10 shadow-xl">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription>Convert PDF pages to PowerPoint slides</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-medium">Slide Layout</label>
                  <select className="w-full p-3 border rounded-lg">
                    <option>One page per slide</option>
                    <option>Two pages per slide</option>
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full p-3 border rounded-lg">
                    ...
                    <option>Google Slides compatible</option>
                  </select>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-display font-semibold">Editable Slides</h3>
              <p className="text-muted-foreground">Get fully editable PowerPoint presentations</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-display font-semibold">Layout Preserved</h3>
              <p className="text-muted-foreground">Maintains original formatting and structure</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-display font-semibold">Quick Processing</h3>
              <p className="text-muted-foreground">Fast conversion without quality loss</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Files deleted automatically after conversion</p>
            </div>
          </div>
        </div>
      </section>
