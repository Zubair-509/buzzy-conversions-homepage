...
import { Minimize, Upload, Settings, Download, Shield, Zap, HardDrive, CheckCircle } from 'lucide-react';
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Reduce PDF file size while maintaining quality. Perfect for email sharing and web optimization.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border-2 border-primary/10 shadow-xl">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-2xl font-display">Upload PDF to Compress</CardTitle>
              <CardDescription>Reduce file size while preserving document quality</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="border-2 border-dashed border-primary/20 rounded-xl p-12 text-center hover:border-primary/40 transition-colors cursor-pointer">
                ...
                <p className="text-muted-foreground mb-4">Select the PDF file you want to compress</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <select className="w-full p-3 border rounded-lg">
                    <option>Recommended (Balanced)</option>
                    <option>High Quality (Less compression)</option>
                    <option>Maximum (Smallest file)</option>
                ...
                <div className="space-y-2">
                  ...
                  <select className="w-full p-3 border rounded-lg">
                    <option>Maintain quality</option>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-display font-semibold">Up to 90% Reduction</h3>
              <p className="text-muted-foreground">Dramatically reduce file sizes</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Smart algorithms maintain readability</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h3 className="text-xl font-display font-semibold">Fast Compression</h3>
              <p className="text-muted-foreground">Quick processing of large files</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Files automatically deleted after compression</p>
            </div>
          </div>
        </div>
      </section>
