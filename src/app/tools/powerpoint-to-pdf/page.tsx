  ...
  const handleDrop = (event: React.DragEvent) => {
    ...
    if (droppedFiles.length > 0) {
      ...
      if (droppedFile.type === 'application/vnd.openxmlformats-officedocument.presentationml.presentation' || 
          droppedFile.name.toLowerCase().endsWith('.pptx')) {
        setFile(droppedFile);
        setError(null);
        setConversionResult(null);
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border-2 border-primary/10 shadow-xl">
            <CardHeader className="text-center pb-8">
              <CardTitle className="text-2xl font-display">Upload Your PowerPoint</CardTitle>
              <CardDescription>Convert .pptx files to PDF format with perfect formatting</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2">{file ? file.name : 'Drop your PowerPoint file here'}</h3>
                <p className="text-muted-foreground mb-4">Support for .pptx format up to 50MB</p>
                <input
                  type="file"
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                      ...
                      {conversionResult.metadata && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                          {conversionResult.metadata.pages && (
                            <div className="text-center">
                              <p className="text-sm text-green-600">Pages</p>
                              <p className="text-lg font-semibold text-green-800">{conversionResult.metadata.pages}</p>
                            </div>
                          )}
                          ...
                          {conversionResult.metadata.method && (
                            <div className="text-center">
                              ...
                              <p className="text-lg font-semibold text-green-800">{conversionResult.metadata.method}</p>
                            </div>
                          )}
                        </div>
                      )}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Convert PowerPoint presentations with complete accuracy, preserving all formatting, images, and slide layouts
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Maintains all formatting, fonts, images, and slide layouts perfectly</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Quick conversion process that saves you time and effort</p>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">Professional-grade PDF output with crisp text and images</p>
            </div>
          </div>
        </div>
      </section>
