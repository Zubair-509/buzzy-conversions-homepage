...
import { FileImage, Upload, Settings, Download, Shield, Zap, Image, CheckCircle } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border-2 border-primary/10 shadow-xl">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription>Convert PDF pages to JPG images</CardDescription>
            </CardHeader>
